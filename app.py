...
def main():
    try:
        ...
        datatrans= datatransformation(data_transformation_config=data_transformation_config,data_ingestion_artifact=dataingstnartfct,data_validation_artifact=datavaldartfct)
        datatrans.initiate_data_transformation()
