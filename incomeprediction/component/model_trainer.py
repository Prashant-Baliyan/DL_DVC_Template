...
from incomeprediction.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from incomeprediction.entity.config_entity import ModelTrainerConfig
from incomeprediction.util.util import save_object,load_object, load_numpy_array_data
from incomeprediction.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from incomeprediction.entity.model_factory import evaluate_regression_model, evaluate_classification_model
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            housing_model = IncomePredictionModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
