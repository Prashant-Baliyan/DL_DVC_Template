...
class incomepredictionexception(Exception):
    ...
    def __init__(self, error_messgae:Exception,error_detail:sys):
        super.__init__(error_messgae)
        self.error_mesasge = incomepredictionexception.get_detailed_error_message(error_message= error_messgae,
